...
int main()
{
    ...
    int start1 = 1, start2 = N / 4, start3 = 2 * N / 4, start4 = 3 * N / 4;

    pthread_create(&th1, NULL, thread, (void *)&start1);
    pthread_create(&th2, NULL, thread, (void *)&start2);
    pthread_create(&th3, NULL, thread, (void *)&start3);
    pthread_create(&th4, NULL, thread, (void *)&start4);
